...
app.get("/generateWheelCode", async (req, res) => {
...
app.get("/generateBasketballCode", async (req, res) => {
  const sessionId = uuidv4();
  const urlSession = `https://dev.ekcs.co/FED/QRBasedControlAd/basketball/phoneControl/index.html?sessionId=${sessionId}`;
